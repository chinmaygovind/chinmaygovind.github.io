...
void updatePose() {
  double differentials[] = {encoderTicks[0] - lastEncoderTicks[0], 
  encoderTicks[1] - lastEncoderTicks[1]};
  double dForward = (differentials[0] + differentials[1]) / TICKS_PER_CM;//forward change in cm
